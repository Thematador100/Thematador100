                    ...
                    <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700 space-y-4">
                        <div>
                            ...
                            <div className="space-y-2 mt-2">
                                {report.technicalImplementation.techStack.map(tech => (
                                    <div key={tech.name} className="bg-slate-950 p-2 rounded">
                     ...
                     <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700 space-y-4">
                        <div>
                            ...
                            <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-3">
                                {report.saasMonetizationModel.pricingTiers.map(tier => (
                                    <div key={tier.name} className="bg-slate-950 p-3 rounded text-center">
