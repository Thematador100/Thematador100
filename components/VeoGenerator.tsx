...
// FIX: Resolved type conflict by defining a global AIStudio interface, which matches the expected type for window.aistudio.
declare global {
    interface AIStudio {
    ...
    interface Window {
        // FIX: Made aistudio optional to match usage and resolve declaration conflict.
        aistudio?: AIStudio;
    }
}
        ...
        return (
             <div className="max-w-2xl mx-auto text-center p-8 bg-slate-800/50 rounded-lg border border-slate-700">
                <div className="flex justify-end -mt-4 -mr-4">
                    <button onClick={onExit} className="text-slate-500 hover:text-slate-300">&times;</button>
                </div>
                <h2 className="text-2xl font-bold text-slate-100">API Key Required for Veo</h2>
                <p className="text-slate-400 my-4">
                    ...
                    Please ensure you have enabled billing for your project.
                </p>
                 <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-400 hover:underline mb-6 block">Learn more about billing</a>
                <button
