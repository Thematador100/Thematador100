    ...
    return (
        <div className="no-print bg-slate-800/70 rounded-xl border border-slate-700 shadow-2xl p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="prospectsToScore" className="block text-sm font-medium text-slate-300 mb-2">
                      Raw Prospect List
                    </label>
                    <textarea
                      id="prospectsToScore"
                      rows={10}
                      className="w-full bg-slate-800 border border-slate-600 rounded-md p-3 text-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 placeholder-slate-500"
                ...
                <div>
                    ...
                    {scoredProspects ? (
                        ...
                        <div className="h-80 flex items-center justify-center bg-slate-900/50 rounded-md border border-slate-700 text-slate-500">
