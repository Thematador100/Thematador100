            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    {report.keyPlayers.map(player => (
                        <div key={player.name} className="bg-slate-900/50 p-4 rounded-lg border border-slate-700">
                ...
                {/* Audience Segments */}
                 <div className="space-y-4">
                    ...
                    {report.audienceSegments.map(segment => (
                         <div key={segment.name} className="bg-slate-900/50 p-4 rounded-lg border border-slate-700">
                            <div className="flex justify-between items-start">
                ...
                <div className="space-y-4">
                    ...
                    {report.whitespaceOpportunities.map(opp => (
                         <div key={opp.opportunityName} className="bg-slate-900/50 p-4 rounded-lg border-2 border-dashed border-green-500/50">
