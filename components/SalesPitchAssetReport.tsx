        ...
        <div className="pt-4 mt-4 border-t border-slate-700">
            ...
            <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700 space-y-4">
                <div>
                    ...
                    <p className="text-slate-300 text-sm italic">"{asset.pitchPersona}"</p>
                </div>
                <div className="relative">
                    ...
                    <pre className="text-slate-300 text-xs whitespace-pre-wrap font-mono bg-slate-950 p-3 rounded-md max-h-40 overflow-y-auto"><code>{asset.pitchScript}</code></pre>
                </div>
                <div className="relative">
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <pre className="text-slate-300 text-xs whitespace-pre-wrap font-mono bg-slate-950 p-3 rounded-md max-h-40 overflow-y-auto"><code>{asset.videoScenePrompt}</code></pre>
                </div>
