...
const RevenuePlayCard: React.FC<{ play: RevenuePlay, onDeploy: (play: RevenuePlay) => void }> = ({ play, onDeploy }) => {
    const probabilityColor = play.probabilityOfSuccess.score > 75 
        ? 'text-green-400 border-green-500' 
        : play.probabilityOfSuccess.score > 50
            ...
            <div className="p-4 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
                    <div className="bg-slate-950/50 p-3 rounded-lg border border-slate-700">
                        ...
                        <p className={`text-3xl font-bold ${probabilityColor}`}>{play.probabilityOfSuccess.score}%</p>
